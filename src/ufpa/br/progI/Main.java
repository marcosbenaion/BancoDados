...
public class Main {
	...
	public static void main(String[] args) 
	{
		...
		BancoDadosClasse Item = new BancoDadosClasse("BD de Classe Item","Item","Classe abstrata Item","ProjetoPicareta",18,12,2013);
		...
		BancoDadosClasse Picareta = new BancoDadosClasse("BD de Classe Picareta","Picareta","Classe abstrata Picareta, estende de Item","ProjetoPicareta",18,12,2013);
		Picareta.imprimirBancoDados();
		System.out.println();
		//criando Banco de dados de atributos de Picareta
		BancoDadosAtributos PicaretaAtributos = new BancoDadosAtributos("BD de Atributos de Picareta","Picareta",18,12,2013);
		//criando atributos
		...
		Metodo decrementarResistencia = new Metodo("decrementarResistencia","Nenhum","Decrementa a resistencia da Picareta quando for utilizada","Sem retorno(void)");
		Metodo iniciarResistencia = new Metodo("iniciarResistencia","Nenhum","Inicia a resistencia da picareta com o valor de resistencia máximo","Sem retorno(void)");
		Metodo verificarResistencia = new Metodo("verificarResistencia","Nenhum","Exibe a resistencia atual da picareta","Sem retorno(void)");
		Metodo reparar = new Metodo("reparar","Nenhum","Restaura a resistencia atual da picareta para o valor de resistencia maximo","Sem retorno(void)");
		...
		BancoDadosClasse PicaretaFerro = new BancoDadosClasse("BD de Classe PicaretaFerro","PicaretaFerro","Classe concreta, estende de Picareta","ProjetoPicareta",18,12,2013);
		BancoDadosMetodos PicaretaFerroMetodos = new BancoDadosMetodos("BD de metodos de PicaretaFerro","PicaretaFerro",18,12,2013);
		Metodo minerarFerro = new Metodo("minerarFerro","Nenhum","Minera o material Ferro, realizando checagem do mesmo e decrementa resistencia da picareta","Sem retorno(void)");
		...
		BancoDadosClasse PicaretaDiamante = new BancoDadosClasse("BD de classe PicaretaDiamante","PicaretaDiamante","Classe concreta, estende de Picareta","ProjetoPicareta",18,12,2013);
		BancoDadosMetodos PicaretaDiamanteMetodos = new BancoDadosMetodos("BD de metodos de PicaretaDiamante","PicaretaDiamante",18,12,2013);
		Metodo minerarDiamante = new Metodo("minerarDiamante","Nenhum","Minera o material Diamante, realiza checagem do material e consome resistencia","Sem retorno(void)");
